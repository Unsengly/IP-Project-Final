  ...
  return (
    <MainAdminPage loading={loading}>
      <div className={"contianFilter"}>
        <Space>
          <div>
            <p className="txtTitle">User ({list?.length})</p>
          </div>
      ...
      <Table
        ...
        //     "RoleId": 1,
        //     "Username": "Admin101",
        //     "Password": "$2b$10$TYlFceXPuDJb.1kcycjeTezU4HrBR4QHi85PVZnxBPrrPAUZVXZ.K",
        //     "IsActive": 1,
        //     "CreateBy": null,
        //     "CreateAt": "2024-04-25T14:00:42.000Z",
        //     "RoleName": "Admin"
        // },
        columns={[
          {
      ...
      />
      <Modal maskClosable={false} open={visible} onCancel={onCloseForm} title={formRef.getFieldValue("Id") ? "Edit User" : "New User"} footer={null}>
        <Form form={formRef} layout="horizontal" labelCol={{ span: 7 }} wrapperCol={{ span: 17 }} onFinish={onFinish}>
          <Form.Item label="User Name" name="Name" rules={[{ required: "true", message: "Please fill in category name!" }]}>
